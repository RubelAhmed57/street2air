...
horizontal_variation = to_scene_units(0.5)  # Maximum variation in horizontal plane (X and Y)
...
for i in range(num_views):
    ...
    # Set render settings
    render_filepath = os.path.join(output_dir, f"{blend_file_name}_view_{i:04d}.png")
